//path: src\app\features\settings\billing\billing.tsx

import moment from "moment"
import { JSXElementConstructor, PromiseLikeOfReactNode, ReactElement, ReactNode, useEffect, useState } from "react"
...
function Billing(){
    ...
    const getPaymentStatus = (status: string | number | boolean | ReactElement<any, string | JSXElementConstructor<any>> | Iterable<ReactNode> | PromiseLikeOfReactNode | null | undefined) => {
