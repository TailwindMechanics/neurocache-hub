//path: src\modules\ThreeFiber\Internal\virtualBackground\buildings.tsx
...
export function Buildings() {
    ...
    const colorArray = [
        IColors.Colors.aqua,
        IColors.Colors.cherry,
        IColors.Colors.grape,
        IColors.Colors.night,
    ];
    ...
    const leftBuildings = generateBuildings(
        buildingCount,
        leftSide,
        positionZ,
        colorArray,
    ...
    const rightBuildings = generateBuildings(
        buildingCount,
        rightSide,
        positionZ,
        colorArray,
