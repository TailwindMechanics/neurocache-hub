...
const Card = new Composer("EntryNodeCard", ShellPreset)
    .withStyle("px-1")
    .build();

const EntryNode = React.memo((props: NodeProps) => {
    ...
    return (
        <>
            ...
            <Card
                ...
                <Icons.Entry className="stroke-fill-none h-5 w-4 stroke-aqua-dark text-aqua" />
            </Card>
        </>
    );
});
