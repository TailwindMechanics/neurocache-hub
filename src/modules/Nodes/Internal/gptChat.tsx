//path: src\modules\Nodes\Internal\gptChat.tsx
...
const Card = new Composer("GptChatCard", ShellPreset)
    .withStyle("py-0.5")
    .withStyle("px-1")
    .build();

const GptChat = React.memo((props: NodeProps) => {
    ...
    return (
        <>
            ...
            <Card
                ...
                <Icons.ChatBubbleLeft className="h-5 w-4 fill-night-black stroke-aqua stroke-20 text-night-dark" />
            </Card>
        </>
    );
});

GptChat.displayName = "GptChat";
export { GptChat };
