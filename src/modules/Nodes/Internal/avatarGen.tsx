//path: src\modules\Nodes\Internal\avatarGen.tsx
...
import { CardPreset, Composer, ShellPreset } from "@modules/Composer";
...
const AvatarGen = React.memo((props: NodeProps) => {
    ...
    return (
        <>
            ...
            <Card
                ...
                <Icons.Image className="h-5 w-4 fill-night-black stroke-aqua stroke-20 text-night-dark" />
            </Card>
        </>
    );
});

AvatarGen.displayName = "AvatarGen";
export { AvatarGen };
