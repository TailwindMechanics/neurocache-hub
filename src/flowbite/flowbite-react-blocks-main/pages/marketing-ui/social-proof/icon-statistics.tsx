...
const StatisticsWithIconsAndCTASocialProof: FC = function () {
  return (
    <section className="bg-white dark:bg-gray-900">
      <div className="mx-auto max-w-screen-xl items-center py-8 px-4 lg:grid lg:grid-cols-4 lg:gap-16 lg:py-16 lg:px-6 xl:gap-24">
        <div className="col-span-2 mb-8">
          <p className="text-lg font-medium text-primary-600 dark:text-primary-500">
            Trusted Worldwide
          </p>
          <h2 className="mt-3 mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white md:text-4xl">
