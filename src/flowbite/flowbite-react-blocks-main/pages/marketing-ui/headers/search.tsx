    ...
    <header>
      <Navbar>
        ...
        <div className="flex items-center gap-3 md:order-2">
          ...
          <HiSearch className="h-5 w-5 md:hidden" />
          <span className="mx-2 hidden h-5 w-px bg-gray-200 lg:mx-3 lg:inline"></span>
          <Dropdown
            color="gray"
            label={
        ...
        <Navbar.Collapse className="md:order-1">
          <form className="mb-3 flex items-center gap-3 md:hidden">
            <div>
              <Label htmlFor="search-bar" className="sr-only">
                Search
              </Label>
