//path: src\app\features\transactions\transactions.tsx
...
import { RECENT_TRANSACTIONS } from "@/app/utils/dummyData";
...
const TopSideButtons: FC<TopSideButtonsProps> = ({
    removeFilter,
    applyFilter,
    applySearch,
}) => {
...
const Transactions: FC = () => {
    const [trans, setTrans] = useState<Transaction[]>(RECENT_TRANSACTIONS);
