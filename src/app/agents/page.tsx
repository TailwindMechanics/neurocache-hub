...
const AgentsRoot: FC = function () {
	return (
		<HubLayout headerText={"Your Agents"}>
			<div className="flex w-full flex-col grayscale">
...
const AddUserModal: FC = function () {
	...
	return (
		<>
			...
			>
				<div className="flex items-center gap-x-3 grayscale">
					...
					<Table.Cell className="w-4 p-4">
						<div className="flex items-center">
							<input
								...
								aria-describedby="checkbox-1"
								type="checkbox"
								className="focus:ring-primary-300 dark:focus:ring-primary-600 h-4 w-4  rounded border-gray-300 focus:ring-4  dark:border-gray-600 dark:ring-offset-gray-800"
							/>
							<label
								htmlFor="checkbox-2"
								className="sr-only"
	...
	return (
		<>
			<Button
				...
				onClick={() => setOpen(true)}
			>
				<div className="flex items-center gap-x-2 grayscale">
...
const Pagination: FC = function () {
	return (
		<div className="sticky bottom-0 right-0 w-full items-center border-t border-gray-200  p-4 dark:border-gray-700  sm:flex sm:justify-between">
			<div className="mb-4 flex items-center sm:mb-0">
				<a
					href="#"
					className="hover: inline-flex cursor-pointer justify-center rounded p-1 text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
				>
					<span className="sr-only">
						Previous page
					</span>
				...
				<a
					href="#"
					className="hover: mr-2 inline-flex cursor-pointer justify-center rounded p-1 text-gray-500 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white"
				>
					<span className="sr-only">
						Next page
					</span>
			...
			<div className="flex items-center space-x-3">
				<a
					href="#"
					className="hover:bg-primary-800 focus:ring-primary-300 dark:hover: dark:focus:ring-primary-800 inline-flex  flex-1 items-center justify-center rounded-lg px-3 py-2 text-center text-sm font-medium  text-white focus:ring-4"
				>
