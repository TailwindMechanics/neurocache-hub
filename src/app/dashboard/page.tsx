...
const SalesThisWeek: FC = function () {
    return (
        <div className="drop-shadow-2xl rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-6 xl:p-8">
...
const SessionsByCountry: FC = function () {
    return (
        <div className="mb-10 rounded-lg bg-white p-4 shadow dark:bg-gray-800 sm:p-6 xl:mb-0 xl:p-8 2xl:col-span-2">
            <div className="mb-10">
                <h3 className="mb-19 text-xl font-bold text-gray-900 dark:text-white">
                    Sessions by country
                </h3>
