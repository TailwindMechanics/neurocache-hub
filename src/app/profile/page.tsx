...
const ProfileRoot: FC = function () {
    return (
        <Hublayout headerText={"Your Profile"}>
            <div className="grid grid-cols-1 px-10 py-10 xl:grid-cols-3 xl:gap-10">
...
const ProfileIntro: FC = function () {
    return (
        <div className="mb-10 p-6 rounded-lg shadow-2xl drop-shadow-2xl border dark:border-main-light dark:bg-main-dark">
            <div className="sm:flex sm:space-x-4 xl:block xl:space-x-0">
                <img
                    alt=""
                    src="/images/bird80px.png"
                    className="grayscale opacity-50 mb-2 h-20 w-20 rounded-lg"
                />
                <div>
                    <h2 className="text-xl font-bold dark:text-text-light">Fart Man</h2>
            ...
            <div>
                ...
                <div className="grayscale opacity-40 flex space-x-3">
                    <svg
                        className="h-6 w-6"
                        viewBox="0 0 17 18"
                        fill="none"
...
const Skills: FC = function () {
    return (
        <div className="grayscale mb-10 rounded-lg bg-main-light p-4 shadow dark:shadow-2xl drop-shadow-2xl border dark:border-main-light dark:bg-main-dark sm:p-6 xl:p-8">
            <div className="flow-root">
                <h3 className="text-xl font-bold dark:text-text-dark">Skills</h3>
                <ul className="mt-4 flex flex-wrap gap-2">
                    <li>
                        <Badge color="gray" size="xl" className="font-normal">
                            Brand Design
                        </Badge>
                    </li>
                    <li>
...
const Hobbies: FC = function () {
    return (
        <div className="mb-10 rounded-lg bg-main-light p-4 shadow dark:shadow-2xl drop-shadow-2xl border dark:border-main-light dark:bg-main-dark sm:p-6 xl:p-8">
            <div className="flow-root">
                <h3 className="text-xl font-bold dark:text-text-light">Hobbies</h3>
                <ul className="mt-4 flex flex-wrap gap-2">
                    <li>
...
const ProgressBars: FC = function () {
    return (
        <div className="mb-10 rounded-lg bg-main-light p-4 shadow dark:shadow-2xl drop-shadow-2xl border dark:border-main-light dark:bg-main-dark sm:p-6 xl:p-8">
            <div className="grayscale grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-16 lg:gap-8 2xl:gap-24">
                <div className=" space-y-6">
                    ...
                    <div>
                        ...
                        <Progress progress={55} color="red" />
                    </div>
                    <div>
                        <div className="mb-1 text-base font-medium text-text-dark dark:text-text-light">
                            HTML
                        </div>
                        <Progress progress={85} color="red" />
                    </div>
                    <div>
                        <div className="mb-1 text-base font-medium text-text-dark dark:text-text-light">
                            React
                        </div>
                        <Progress progress={65} color="red" />
                    </div>
                </div>
                <div className="space-y-6">
                    <div>
                    ...
                    <div>
                        ...
                        <Progress progress={90} color="red" />
                    </div>
                    <div>
                        <div className="mb-1 text-base font-medium text-text-dark dark:text-text-light">
                            Product Design
                        </div>
                        <Progress progress={99} color="red" />
                    </div>
                    <div>
                        <div className="mb-1 text-base font-medium text-text-dark dark:text-text-light">
                            Angular
